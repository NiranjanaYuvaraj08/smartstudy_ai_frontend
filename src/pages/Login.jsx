            ...
            <div className="max-w-6xl mx-auto px-6 md:px-10 py-10 flex justify-center items-center min-h-[calc(100vh-100px)]">
                <div className="w-full max-w-md card p-8">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h2 className="text-2xl md:text-3xl font-semibold text-white">Welcome Back</h2>
                        <p className="text-emerald-300/70 mt-2 text-sm text-center">Sign in to continue your secure session.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button type="submit" className="btn-primary w-full py-4 mt-4">Initialize Session</button>
                    </form>

                    <div className="mt-8 text-center text-sm text-emerald-300/70">
                        Don't have access? <Link to="/register" className="text-emerald-400 font-bold hover:text-emerald-300 transition-colors">Request Access</Link>
                    </div>
                </div>
            </div>
        </div>
